  ...
  return (
    <div className='flex flex-row'>
      ...
      <div className=' basis-1/3 shadow-lg shadow-white min-h-screen max-h-full flex-col flex items-center justify-center text-5xl font-bold'>
        <h1 className="text-2xl font-bold mb-6 text-center">Formulário de login</h1>
      ...
      <div className='basis-2/3 flex items-center justify-center'>
        ...
        <form onSubmit={onSubmit} method='POST' action='#' className="w-full max-w-sm mx-auto bg-zinc-100 text-gray-800 p-8 rounded-md shadow-md">
          ...
          <button
            className="w-full mb-2 bg-indigo-500 text-white text-sm font-bold py-2 px-4 rounded-md hover:bg-indigo-600 transition duration-300"
            type="submit">Entrar</button>
          <a href='/register'>
            <button
              className="w-full bg-gray-300 text-white text-sm font-bold py-2 px-4 rounded-md hover:bg-gray-400 transition duration-300"
              type="button">Não possui uma conta?</button>
          </a>
        </form>
      </div>
